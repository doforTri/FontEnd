        ...
        <HeaderStyle>
          ...
          {smUp && (
            <Typography variant="body2" sx={{ mt: { md: -2 } }}>
              ...
              <Link variant="subtitle2" component={RouterLink} to={PATH_HOME.loginBuyer}>
                Login
              </Link>
            </Typography>
          )}
        ...
        {mdUp && (
          <SectionStyle>
            ...
            <Image
              ...
              disabledEffect
              alt="register"
              src="https://th.bing.com/th/id/R.f3e633d10305c17bfa6f4eb3eb8b4c3f?rik=46tQrU8%2fY0fOtQ&pid=ImgRaw&r=0"
            />
          </SectionStyle>
        )}
          ...
          <ContentStyle>
            ...
            {!smUp && (
              <Typography variant="body2" sx={{ mt: 3, textAlign: 'center' }}>
                Already have an account?{' '}
                <Link variant="subtitle2" to={PATH_HOME.loginBuyer} component={RouterLink}>
                  Login
                </Link>
              </Typography>
            )}
